...
export const buildTable: BuildItemDisplay[][] = [
  [
    ...
    {
      unitType: UnitType.SuperMIRV,
      icon: mirvIcon,
      description: "build_menu.desc.super_mirv",
      key: "unit_type.super_mirv",
      countable: false,
    },
    {
    ...
    },
    {
      ...
      icon: warshipIcon,
      description: "build_menu.desc.helicopter",
      key: "unit_type.helicopter",
      countable: true,
    },
    {
